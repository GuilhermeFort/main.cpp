...
const checks=[
  ['lib/gemini.ts',['gemini-3.6-flash','generateContent','thinkingLevel','generateMystery','answerMystery']],
  ['lib/case.ts',['defaultWorld','quarto-1209','celular-rafael','camera-corredor-12']],
  ['lib/psychology.ts',['character_states']],
  ['lib/learning.ts',['ai_training_examples','ai_memory_items']],
  ['lib/student.ts',['runStudentShadow','ai_evaluations']],
  ['app/api/messages/route.ts',['answerMystery','runStudentShadow']],
  ['app/api/investigation-state/route.ts',['evidence_items','timeline_events','hypotheses','investigation_tasks','player_private_notes']],
  ['app/api/world-state/route.ts',['case_locations','digital_devices','digital_artifacts','surveillance_cameras','camera_events','investigation_board_nodes','legal_requests','case_assessments','trial_sessions','search_location','extract_device','review_camera','prosecutor_review']],
